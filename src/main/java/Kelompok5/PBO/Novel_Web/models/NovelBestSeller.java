...
public class NovelBestSeller extends Novel {
    ...
    public NovelBestSeller(String judul, String penulis, String genre, Object object, double harga, int diskon, int tahunTerbit, int jumlahHalaman, String coverUrl) {
